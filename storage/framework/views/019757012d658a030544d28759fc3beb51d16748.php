    ...
    <ul class="nav navbar-nav float-right">
        <?php if(auth()->guard()->check()): ?>
            <?php if(BaseHelper::getAdminPrefix() != ''): ?>
                <li class="dropdown">
                    <a class="dropdown-toggle dropdown-header-name" style="padding-right: 10px" href="<?php echo e(url('/')); ?>" target="_blank"><i class="fa fa-globe"></i> <span <?php if(isset($themes) && setting('enable_change_admin_theme') != false): ?> class="d-none d-sm-inline" <?php endif; ?>><?php echo e(trans('core/base::layouts.view_website')); ?></span> </a>
                </li>
            <?php endif; ?>
            <?php if(Auth::check()): ?>
            ...
            <li class="dropdown dropdown-user">
                <a href="javascript:void(0)" class="dropdown-toggle dropdown-header-name" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    ...
                    <span class="username"> <?php echo e(Auth::user()->getFullName()); ?> </span>
                    <i class="fa fa-angle-down"></i>
                </a>
                <ul class="dropdown-menu">
                    <li><a href="<?php echo e(route('users.profile.view', Auth::user()->getKey())); ?>"><i class="icon-user"></i> <?php echo e(trans('core/base::layouts.profile')); ?></a></li>
...
<?php /**PATH /home/inmobi85/unviajecitoalaluna.bestlinecancun.com/platform/core/base/resources/views//layouts/partials/top-menu.blade.php ENDPATH**/ ?>