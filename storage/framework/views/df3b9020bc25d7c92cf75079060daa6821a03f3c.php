                    ...
                    <div class="row pad">
                        <?php $__currentLoopData = ThemeManager::getThemes(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key =>  $theme): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="col-sm-6 col-md-4 col-lg-3">
                                <div class="thumbnail">
                                    <div class="img-thumbnail-wrap" style="background-image: url('<?php echo e(url(config('packages.theme.general.themeDir'))); ?>/<?php echo e($key); ?>/screenshot.png')"></div>
                                    <div class="caption">
...
<?php echo $__env->make('core/base::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/inmobi85/unviajecitoalaluna.bestlinecancun.com/platform/packages/theme/resources/views//list.blade.php ENDPATH**/ ?>