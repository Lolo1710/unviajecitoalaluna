                        ...
                        <div class="thumb">
                            <div class="profile-userpic mt-card-item">
                                ...
                                <div class="mt-card-content">
                                    <h3 class="mt-card-name"><?php echo e($user->getFullName()); ?></h3>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="modal-content">
                            <form class="avatar-form" method="post" action="<?php echo e(route('users.profile.image', $user->id)); ?>" enctype="multipart/form-data">
                                ...
                                <div class="modal-footer">
                                    <button class="btn btn-secondary" type="button" data-dismiss="modal"><?php echo e(trans('core/acl::users.close')); ?></button>
            ...
            <div class="profile-content">
                <div class="tabbable-custom">
                    <ul class="nav nav-tabs">
                        <li class="nav-item">
                            <a href="#tab_1_1" class="nav-link active" data-toggle="tab" aria-expanded="true"><?php echo e(trans('core/acl::users.info.title')); ?></a>
                        </li>
                        <?php if($canChangeProfile): ?>
                            <li class="nav-item">
                                <a href="#tab_1_3" class="nav-link" data-toggle="tab" aria-expanded="false"><?php echo e(trans('core/acl::users.change_password')); ?></a>
                            </li>
                        <?php endif; ?>
...
<?php echo $__env->make('core/base::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/inmobi85/unviajecitoalaluna.bestlinecancun.com/platform/core/acl/resources/views//users/profile/base.blade.php ENDPATH**/ ?>