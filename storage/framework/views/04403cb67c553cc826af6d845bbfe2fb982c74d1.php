            ...
            <div class="widget meta-boxes">
                ...
                <div class="widget-body">
                    ...
                    <?php if(defined('THEME_MODULE_SCREEN_NAME')): ?>
                        <hr>
                        <h3><?php echo e(trans('packages/menu::menu.menu_settings')); ?></h3>
                        <div class="row">
                            <div class="col-md-4">
...
<?php endif; ?>
<?php /**PATH /home/inmobi85/unviajecitoalaluna.bestlinecancun.com/platform/packages/menu/resources/views//menu-structure.blade.php ENDPATH**/ ?>