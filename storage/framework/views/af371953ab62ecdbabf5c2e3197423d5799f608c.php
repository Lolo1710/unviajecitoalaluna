<div class="flexbox-annotated-section">
    ...
    <div class="flexbox-annotated-section-content">
        <div class="wrapper-content pd-all-20">
            ...
            <div class="form-group">
                <label class="text-title-field"
                       for="view_id"><?php echo e(trans('plugins/analytics::analytics.settings.view_id')); ?></label>
...
</div><?php /**PATH /home/inmobi85/unviajecitoalaluna.bestlinecancun.com/platform/plugins/analytics/resources/views//setting.blade.php ENDPATH**/ ?>