<li class="dropdown dropdown-extended dropdown-inbox" id="header_inbox_bar">
    ...
    <ul class="dropdown-menu dropdown-menu-right">
        <li class="external">
            <h3><?php echo clean(trans('plugins/contact::contact.new_msg_notice', ['count' => count($contacts)])); ?></h3>
                ...
                <?php $__currentLoopData = $contacts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $contact): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <li>
                        <a href="<?php echo e(route('contacts.edit', $contact->id)); ?>">
                            <span class="photo">
                                <img src="<?php echo e((new \Botble\Base\Supports\Avatar)->create($contact->name)->toBase64()); ?>" class="rounded-circle" alt="<?php echo e($contact->name); ?>">
                            </span>
...
<?php /**PATH /home/inmobi85/unviajecitoalaluna.bestlinecancun.com/platform/plugins/contact/resources/views//partials/notification.blade.php ENDPATH**/ ?>