...
<div class="form-group">
    <label for="number_display"><?php echo e(__('Number gallery to display')); ?></label>
    <input type="number" class="form-control" name="number_display" value="<?php echo e($config['number_display']); ?>">
</div>
<?php /**PATH /home/inmobi85/unviajecitoalaluna.bestlinecancun.com/platform/themes/stories/////widgets/galleries/templates/backend.blade.php ENDPATH**/ ?>