                ...
                <div class="container">
                    <div class="row pt-20 pb-20">
                        ...
                        <div class="col-md-9 col-6 text-right header-top-right">
                            ...
                            <button class="search-icon d-none d-md-inline"><span class="mr-15 text-muted font-small"><i class="elegant-icon icon_search mr-5"></i>{{ __('Search') }}</span></button>
                            @if (theme_option('action_button_text') && theme_option('action_button_url'))
                                <a href="{{ url(theme_option('action_button_url')) }}" class="btn btn-radius bg-primary text-white ml-15 font-small box-shadow">{{ theme_option('action_button_text') }}</a>
                            @endif
                        </div>
                    </div>
                </div>
                ...
                <div class="pt-50 pb-50 ">
                    <div class="row mb-20">
                        <div class="col-12 align-self-center main-search-form-cover m-auto">
                            ...
                            <form action="{{ route('public.search') }}" class="search-header">
